      ...
      <ul className="restaurant-list">
        <li className="restaurant">
          <div className="restaurant__category">
            <img
              src="../assets/category-korean.png"
              alt="한식"
        ...
        <li className="restaurant">
          <div className="restaurant__category">
            <img
              src="../assets/category-chinese.png"
              alt="중식"
              className="category-icon"
            />
          </div>
        ...
        <li className="restaurant">
          <div className="restaurant__category">
            <img
              src="../assets/category-japanese.png"
              alt="일식"
              className="category-icon"
            />
          </div>
        ...
        <li className="restaurant">
          <div className="restaurant__category">
            <img
              src="../assets/category-western.png"
              alt="양식"
              className="category-icon"
            />
          </div>
